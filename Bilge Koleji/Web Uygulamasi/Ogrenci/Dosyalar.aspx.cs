...
namespace Web_Uygulamasi.Ogrenci
{
    public partial class Dosyalar : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("SELECT o.OgretmenID, ad.DersAdi, o.OgretmenAdi + ' ' + o.OgretmenSoyadi AS Ogretmen, d.DosyaAdi, d.Boyut, d.Tarih, d.DosyaID, d.YeniDosyaAdi FROM Dosyalar d JOIN Ogretmenler o ON d.OgretmenID=o.OgretmenID JOIN AnaDersler ad ON ad.AnaDersID=o.Brans WHERE d.OgrenciID = @OgrenciID ORDER BY d.Tarih DESC", conn);
