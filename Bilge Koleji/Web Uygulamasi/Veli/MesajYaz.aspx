<%@ Page Title="" Language="C#" MasterPageFile="~/Veli/Main.Master" AutoEventWireup="true"
    CodeBehind="MesajYaz.aspx.cs" Inherits="Web_Uygulamasi.Veli.MesajYaz" %>
            ...
            <tr>
                ...
                <td align="left" class="style1">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBaslik"
                        Display="Dynamic" ErrorMessage="Başlık Yazmadınız!" ValidationGroup="Grup1">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
