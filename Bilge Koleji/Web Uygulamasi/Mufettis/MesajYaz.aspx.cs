    ...
    public partial class MesajYaz : System.Web.UI.Page
    {
        ...
        protected void btnKaydet_Click(object sender, EventArgs e)
        {
            if (veriId != "")
            {
                ...
                {
                    string sonuc = dbIslem.dbEkleVeriIslem("Mesajlar", null, null, "Baslik", "Mesaj", "KimdenID", "KimeID", "OkunduMu", "Tarih", txtBaslik.Text, txtMesaj.Text, Membership.GetUser(HttpContext.Current.User.Identity.Name).ProviderUserKey.ToString(), veriId, "0", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
                    if (sonuc.Length > 0)
